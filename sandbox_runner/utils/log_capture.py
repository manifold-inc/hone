...
class LogCapture:
    ...
    def __init__(self, job_id: str, phase: str, show_terminal: bool = True):
        """
    ...
    def capture_lines(self, lines: List[str], level: str = "info"):
        ...
        if self.log_manager:
            ...
            self.log_manager.append_logs_batch(
                job_id=self.job_id, phase=self.phase, messages=clean_lines, level=level
            )
        ...
        async for chunk in stream:
            if chunk:
                ...
                while "\n" in buffer:
                    ...
                    if (
                        line or buffer
                    ):  # Don't process empty lines unless there's more content
...
class BuildLogDisplayAdapter:
    ...
    def __init__(
        self, original_display, job_id: str, phase: str, show_terminal: bool = True
    ):
        """
