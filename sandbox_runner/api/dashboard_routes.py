...
def create_dashboard_router(config: Config) -> APIRouter:
    ...
    @router.get("/dashboard/jobs/completed", summary="Get completed jobs with metrics")
            ...
            for result_file in result_files:
                ...
                try:
                    ...
                    if result_data.get("metrics"):
                        job_data["metrics"] = result_data["metrics"].get(
                            "aggregate", {}
                        )
