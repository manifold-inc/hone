    ...
    if rows is None:
        ...
        while True:
            ...
            if not common.randint(0, 3):
                wides[0], talls[0] = 1, 4  # Rare tetris "I".
            for i in range(num_sprites):  # Flip the orientation of a few.
                if common.randint(0, 1):
                    wides[i], talls[i] = talls[i], wides[i]
...
def validate():
    ...
    train = [
        generate(
            rows=[0, 0, 1, 1, 0, 0, 1, 1, 0, 1, 2, 0, 0, 0, 1, 0, 1, 1],
        ...
        generate(
            rows=[0, 0, 0, 0, 1, 0, 0, 1, 0, 1, 1, 1, 0, 0, 1, 1],
    ...
    test = [
        generate(
            rows=[0, 1, 2, 3, 0, 0, 1, 1, 0, 0, 1, 0, 1, 2, 0, 0, 0, 1],
