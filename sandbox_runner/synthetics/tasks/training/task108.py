...
def validate():
    ...
    train = [
        generate(
            rows=[0, 1, 1, 2, 3, 4], cols=[0, 0, 1, 2, 3, 4], colors=[2, 4, 1, 3, 4, 3]
        ),
        generate(
            rows=[0, 0, 1, 3, 4, 4], cols=[0, 1, 1, 4, 3, 4], colors=[1, 3, 4, 8, 2, 2]
        ),
        generate(rows=[0, 0, 4, 4, 4], cols=[0, 1, 0, 1, 4], colors=[3, 2, 1, 1, 4]),
    ]
    test = [
        generate(rows=[1, 2, 3, 3, 4], cols=[1, 2, 1, 3, 0], colors=[6, 1, 3, 4, 2]),
    ]
