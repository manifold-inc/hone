...
def generate(
    width=None, height=None, start=None, sep=None, bottoms=None, colors=None, xpose=None
):
...
def validate():
    ...
    train = [
        generate(
            width=25, height=10, start=5, sep=1, bottoms=[0, 1], colors=[2, 8], xpose=0
        ),
        generate(
            width=23, height=7, start=5, sep=2, bottoms=[0, 1], colors=[1, 3], xpose=0
        ),
        generate(
            width=22, height=9, start=5, sep=1, bottoms=[0, 1], colors=[2, 3], xpose=1
        ),
        generate(
            width=24, height=8, start=7, sep=3, bottoms=[0, 0], colors=[4, 1], xpose=1
        ),
    ]
    test = [
        generate(
            width=27, height=11, start=5, sep=4, bottoms=[0, 1], colors=[3, 4], xpose=0
        ),
    ]
