...
def validate():
    ...
    train = [
        generate(
            size=5, rows=[1, 2, 2, 3, 3], cols=[1, 0, 1, 1, 2], color=1, linecolor=2
        ),
        generate(
            size=4, rows=[0, 0, 1, 1, 2], cols=[0, 2, 0, 1, 0], color=3, linecolor=8
        ),
        generate(size=3, rows=[0, 1, 1, 2], cols=[0, 1, 2, 1], color=2, linecolor=4),
    ]
    test = [
        generate(
            size=6,
