...
def generate(
    size=None, spacing=None, linecolor=None, brow=None, bcol=None, colors=None
):
    ...
    if size is None:
        ...
        while True:
            ...
            if len(set(colors)) != num_colors + 1:
                continue  # Need all (plus black)
                    ...
                    for dr in [-1, 0, 1]:
                        for dc in [-1, 0, 1]:
                            ...
                            if (
                                ...
                                continue
                            if colors[r * 3 + c] != colors[row * 3 + col]:
                                illegal = True
