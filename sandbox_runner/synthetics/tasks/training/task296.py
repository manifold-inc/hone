...
def validate():
    ...
    train = [
        generate(
            rows=[0, 0, 1, 1, 1, 1, 3, 3, 3, 3, 4, 4],
            cols=[1, 5, 0, 1, 5, 6, 0, 1, 5, 6, 1, 5],
            color=8,
        ),
        generate(
            rows=[0, 0, 0, 0, 1, 3, 3, 4, 4], cols=[0, 1, 5, 6, 6, 1, 5, 0, 6], color=2
        ),
        generate(rows=[0, 0, 0, 1, 1, 4, 4], cols=[0, 1, 5, 5, 6, 0, 6], color=4),
