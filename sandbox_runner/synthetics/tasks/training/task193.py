...
def generate(
    ...
    def draw(grid, output):
        ...
        for boxrow, boxcol, wide, tall in zip(boxrows, boxcols, wides, talls):
            ...
            if len([b for b in border if b == color]) > 1:
                return False
        return True
    ...
    if size is None:
        ...
        while True:
            ...
            if not common.overlaps(boxrows, boxcols, wides, talls, 1):
                break
        while True:
...
def validate():
    ...
    train = [
        ...
        generate(
            size=17,
            rows=[1, 2, 2, 3, 4, 6, 9, 10, 12, 15, 16],
            cols=[12, 1, 6, 16, 4, 12, 13, 3, 7, 13, 10],
            color=6,
            boxrows=[2, 5, 10, 12],
            boxcols=[11, 3, 9, 2],
            wides=[3, 4, 5, 2],
    ...
    test = [
        generate(
            size=10,
            rows=[0, 1, 1, 3, 4, 5, 7, 8, 9, 9],
            cols=[9, 1, 7, 7, 0, 9, 0, 2, 4, 9],
            color=8,
            boxrows=[2, 5],
            boxcols=[1, 4],
            wides=[3, 5],
