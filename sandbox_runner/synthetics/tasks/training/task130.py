...
def generate(rows=None, cols=None, colors=None, pixelrows=None, pixelcols=None, size=3):
    ...
    if rows is None:
        ...
        for r in range(size):
            for c in range(size):
                ...
                if rand > 5:
                    continue  # sometimes we leave it empty
...
def validate():
    ...
    train = [
        ...
        generate(
            ...
            cols=[1, 1],
            colors=[2, 7],
            pixelrows=[1, 3, 4, 4, 6, 7],
            pixelcols=[1, 0, 3, 7, 1, 5],
        ),
    ]
    test = [
        generate(
            ...
            cols=[0, 1, 1],
            colors=[4, 3, 9],
            pixelrows=[0, 1, 2, 3, 6, 7],
            pixelcols=[7, 0, 4, 7, 2, 4],
        ),
    ]
