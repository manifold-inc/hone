...
def generate(
    size=None, rows=None, cols=None, brows=None, bcols=None, wides=None, talls=None
):
    ...
    if size is None:
        ...
        while True:
            ...
            if max(wides) > size or max(talls) > size:
                continue
...
def validate():
    ...
    train = [
        ...
        generate(
            size=10,
            rows=[1, 1, 2, 2, 3, 5, 5, 6, 6, 6, 7],
            cols=[2, 4, 3, 5, 2, 3, 5, 2, 3, 4, 3],
            brows=[3],
            bcols=[5],
            wides=[3],
            talls=[3],
        ...
        generate(
            size=10,
            rows=[1, 1, 3, 4, 4, 4, 4, 4, 5, 5, 6, 6, 7],
            cols=[2, 5, 7, 2, 5, 6, 7, 8, 3, 8, 3, 7, 3],
            brows=[1, 6, 7],
            bcols=[2, 7, 3],
            wides=[4, 3, 3],
            talls=[4, 3, 3],
    ...
    test = [
        generate(
            size=20,
            rows=[2, 3, 5, 5, 6, 6, 9, 11, 12, 12, 12, 13, 15, 15, 15, 15, 18, 18],
            cols=[4, 4, 4, 12, 13, 17, 9, 9, 6, 13, 17, 9, 4, 6, 7, 11, 7, 11],
            brows=[1, 3, 3, 6, 9, 11, 13, 15],
            bcols=[1, 4, 9, 13, 9, 7, 1, 7],
            wides=[3, 6, 4, 5, 5, 3, 3, 5],
