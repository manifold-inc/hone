...
def generate(rows=None, cols=None, row=None, col=None, color=None, kite=None, size=20):
    ...
    def kite_above(r, c):
        if grid[r][c] == kite:
            return False  # edge case (we're inside the kite!)
        while r >= 0:
            if grid[r][c] == kite:
                return True
            r -= 1
...
def validate():
    ...
    train = [
        generate(
            rows=[2, 3, 4, 10, 10, 13, 18, 19],
            cols=[5, 16, 3, 1, 18, 9, 15, 1],
            row=5,
            col=9,
            color=8,
            kite=9,
        ...
        generate(
            rows=[1, 2, 4, 4, 9, 10, 10, 12, 14, 17, 18],
            cols=[8, 2, 13, 16, 17, 1, 9, 6, 16, 14, 1],
            row=5,
            col=7,
            color=2,
            kite=7,
        ...
        generate(
            ...
            cols=[14, 5, 10, 1, 7, 18, 4, 10, 2, 0, 7, 13, 18, 4, 12, 1, 16, 7, 13, 19],
            row=4,
            col=12,
            color=3,
            kite=4,
    ...
    test = [
        generate(
            rows=[1, 1, 1, 2, 3, 5, 5, 7, 7, 8, 8, 10, 12, 12, 12, 14, 16, 16, 18, 19],
            cols=[
                4,
                10,
                18,
