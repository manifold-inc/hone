...
def generate(
    height=None, rows=None, cols=None, offset=None, color=None, diag=None, width=10
):
    ...
    if height is None:
        ...
        while True:
            ...
            if len(set(rows)) == tall and len(set(cols)) == wide:
                break
...
def validate():
    ...
    train = [
        generate(
            height=6, rows=[0, 0, 0, 1], cols=[0, 1, 2, 2], offset=0, color=1, diag=1
        ),
        generate(height=5, rows=[0], cols=[0], offset=2, color=3, diag=0),
        generate(
            height=8, rows=[0, 1, 2, 2], cols=[1, 1, 0, 2], offset=0, color=2, diag=0
        ),
    ]
    test = [
