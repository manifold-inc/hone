...
def generate(rows=None, cols=None, idxs=None, colors=None, size=3):
    ...
    grid, output = common.grid_enhance(
        size, len(colors), rows, cols, idxs, colors, common.black()
    )
...
def validate():
    ...
    train = [
        generate(
            rows=[0, 0, 1, 1], cols=[0, 1, 1, 2], idxs=[0, 1, 0, 0], colors=[6, 7]
        ),
        generate(
            rows=[0, 0, 1, 2], cols=[0, 2, 1, 1], idxs=[0, 1, 1, 0], colors=[1, 4]
        ),
        generate(
            rows=[0, 0, 1, 1], cols=[0, 1, 1, 2], idxs=[0, 1, 2, 0], colors=[3, 2, 7]
        ),
        generate(
            rows=[0, 1, 1, 2, 2],
            cols=[1, 1, 2, 0, 1],
