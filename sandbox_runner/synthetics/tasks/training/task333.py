...
def generate(rows=None, cols=None, colors=None, boxrow=None, boxcol=None, size=10):
    ...
    if rows is None:
        while True:
            ...
            color_list = common.random_colors(
                common.randint(1, 2), exclude=[common.green()]
            )
...
def validate():
    ...
    train = [
        generate(
            rows=[0, 1, 3, 6, 7, 8, 9],
            cols=[0, 8, 8, 7, 6, 2, 4],
            colors=[1, 6, 1, 6, 6, 6, 1],
            boxrow=3,
            boxcol=2,
        ),
        generate(
            rows=[0, 0, 2, 2, 5, 6, 7, 8, 9, 9],
            cols=[1, 6, 3, 9, 1, 8, 3, 1, 5, 9],
            colors=[7, 8, 7, 8, 8, 8, 8, 7, 7, 7],
            boxrow=2,
            boxcol=5,
        ),
        generate(
    ...
    test = [
        generate(
            rows=[0, 1, 2, 3, 4, 6, 8, 9, 9],
            cols=[3, 0, 7, 0, 7, 0, 7, 3, 5],
            colors=[2, 2, 2, 6, 6, 6, 2, 6, 6],
            boxrow=6,
            boxcol=2,
        ),
    ]
