...
def generate(width=None, height=None, rows=None, cols=None, wides=None, colors=None):
...
def validate():
    ...
    train = [
        generate(
            width=30, height=8, rows=[1, 5], cols=[0, 12], wides=[29, 13], colors=[4, 8]
        ),
        generate(
            width=20, height=8, rows=[1, 5], cols=[1, 7], wides=[9, 11], colors=[1, 7]
        ),
    ]
    test = [
        generate(
