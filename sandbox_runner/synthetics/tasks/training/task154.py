...
def generate(
    ...
    if rows is None:
        ...
        while True:
            ...
            if not common.diagonally_connected(top):
                continue
            if not common.diagonally_connected(bottom):
                continue
            ...
            if top_mid != bot_mid:
                continue
            if min(cols) > 0 or max(cols) < wide - 3:
                continue
            break
...
def validate():
    ...
    train = [
        ...
        generate(
            rows=[0, 0, 0, 1, 2, 2, 3, 3],
            cols=[0, 1, 2, 1, 1, 2, 0, 1],
            wide=5,
            tall=8,
            brow=3,
            bcol=4,
    ...
    test = [
        generate(
            rows=[1, 1, 1, 0, 0, 0, 0, 4, 3, 3, 3, 3, 3],
