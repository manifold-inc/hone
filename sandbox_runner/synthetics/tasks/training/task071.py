...
def validate():
    ...
    train = [
        generate(
            rows=[0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 6, 7, 7, 8],
        ...
        generate(
            rows=[0, 1, 1, 1, 2, 2, 2, 2, 3, 3, 4, 5, 5, 5, 6, 6, 6, 7, 7],
    ...
    test = [
        generate(
            rows=[0, 1, 1, 1, 2, 2, 3, 3, 3, 3, 3, 4, 5, 5, 5, 5, 5, 6, 6, 6, 7],
            cols=[2, 0, 1, 3, 3, 4, 0, 1, 2, 3, 4, 0, 0, 1, 2, 3, 4, 0, 2, 3, 2],
            srow=5,
            scol=6,
            brow=6,
            bcol=8,
