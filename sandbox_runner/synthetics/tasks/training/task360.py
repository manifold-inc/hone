...
def generate(
    rows=None, cols=None, colors=None, lefts=None, rights=None, width=4, height=10
):
...
def validate():
    ...
    train = [
        ...
        generate(
            rows=[1, 2, 2, 3, 4, 4, 4, 5, 5, 6, 7, 7, 7, 8],
    ...
    test = [
        generate(
            rows=[1, 2, 3, 3, 3, 3, 4, 4, 5, 5, 5, 6, 7, 7, 8],
