...
def generate(
    rows=None, cols=None, colors=None, flip_horiz=None, flip_vert=None, size=6
):
...
def validate():
    ...
    train = [
        generate(
            rows=[0, 0, 1, 1, 1, 1, 1, 1, 2, 2, 3, 3, 4, 4, 4, 4, 4, 4, 5, 5],
            cols=[1, 4, 0, 1, 2, 3, 4, 5, 1, 4, 1, 4, 0, 1, 2, 3, 4, 5, 1, 4],
            colors=[2, 4, 1, 6],
            flip_horiz=0,
            flip_vert=0,
        ),
        generate(
            rows=[0, 0, 0, 1, 1, 2, 2, 2, 2, 3, 4, 4, 4, 4, 4, 4, 5],
        ...
        generate(
            rows=[0, 0, 1, 1, 2, 3, 3, 3, 3, 4, 4, 5, 5],
    ...
    test = [
        generate(
            rows=[0, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 4, 5],
