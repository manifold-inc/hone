    ...
    if rows is None:
        ...
        for idx in [0, 1]:
            ...
            while True:
                ...
                if common.diagonally_connected(pixels):
                    break
        ...
        while True:
            ...
            if not common.overlaps(megarows, megacols, megalens, megalens, 1):
                break
...
def validate():
    ...
    train = [
        ...
        generate(
            rows=[0, 0, 0, 1, 0, 0, 1, 1],
            cols=[0, 1, 2, 0, 0, 1, 1, 2],
            idxs=[1, 1, 1, 1, 0, 0, 0, 0],
            colors=[3, 8, 8, 8, 4, 2, 4, 4],
            megarows=[2, 8, 7, 1],
            megacols=[2, 1, 6, 9],
            megaidxs=[1, 1, 0, 0],
        ),
        generate(
            rows=[0, 0, 0, 1, 1, 2, 0, 0, 1, 1, 1],
