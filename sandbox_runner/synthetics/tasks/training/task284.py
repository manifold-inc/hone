...
def generate(
    width=None, height=None, row=None, col=None, half=None, colors=None, xpose=None
):
...
def validate():
    ...
    train = [
        generate(width=14, height=10, row=2, col=1, half=5, colors=[2, 8], xpose=1),
        generate(width=13, height=10, row=4, col=1, half=6, colors=[3, 1], xpose=0),
        generate(width=18, height=10, row=3, col=3, half=7, colors=[5, 8], xpose=0),
    ]
    test = [
        generate(width=19, height=9, row=1, col=1, half=8, colors=[7, 6], xpose=1),
    ]
