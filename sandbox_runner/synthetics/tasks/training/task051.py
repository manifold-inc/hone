...
def generate(
    width=None, height=None, depth=None, row=None, col=None, colors=None, gravity=None
):
...
def validate():
    ...
    train = [
        generate(width=10, height=15, depth=3, row=3, col=4, colors=[2, 1], gravity=1),
        generate(width=12, height=12, depth=4, row=3, col=6, colors=[8, 3], gravity=2),
        generate(width=12, height=15, depth=3, row=2, col=4, colors=[3, 2], gravity=0),
    ]
    test = [
        generate(width=11, height=16, depth=4, row=1, col=4, colors=[4, 8], gravity=2),
    ]
