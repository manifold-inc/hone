...
def generate(width=None, height=None, rows=None, cols=None, idxs=None):
    ...
    if width is None:
        ...
        while True:
            ...
            if not common.overlaps(brows, bcols, bwides, btalls):
                break
        ...
        while True:
            ...
            if not common.overlaps(
                brows + srows, bcols + scols, bwides + swides, btalls + stalls
            ):
                break
        rows = brows + srows
        cols = bcols + scols
...
def validate():
    ...
    train = [
        ...
        generate(
            width=9, height=8, rows=[1, 4, 1, 3], cols=[4, 4, 1, 3], idxs=[0, 0, 2, 1]
        ),
    ]
    test = [
        generate(
