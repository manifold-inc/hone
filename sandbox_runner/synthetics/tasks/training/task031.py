    ...
    if height is None:
        ...
        while queue:
            ...
            if r == 0 or r == height - 1 or c == 0 or c == width - 1:
                continue
            if neighbor_count(r, c) > 1 or (r, c) in pixels:
                continue
            pixels.append((r, c))
...
def validate():
    ...
    train = [
        generate(
            height=10,
            rows=[2, 2, 2, 3, 4, 4, 4, 5, 5],
            cols=[4, 5, 6, 5, 3, 4, 5, 3, 5],
            color=2,
        ),
        generate(
            height=11,
            rows=[1, 2, 2, 3, 4, 4, 4, 5],
            cols=[2, 2, 3, 3, 2, 3, 4, 4],
            color=1,
        ),
        generate(
            height=12,
            rows=[3, 3, 4, 4, 4, 4, 5, 5],
            cols=[4, 6, 3, 4, 5, 6, 6, 7],
            color=8,
        ),
    ]
    test = [
        generate(
            height=12,
            rows=[4, 4, 4, 4, 5, 6, 6, 7, 7, 7, 7],
            cols=[4, 5, 6, 7, 4, 2, 4, 2, 3, 4, 5],
            color=6,
        ),
    ]
