        ...
        for i in range(len(rows)):
            ...
            for dr in range(bmag):
                for dc in range(bmag):
                    ...
                    if idx and i not in [0, show]:
                        continue  # Usually draw just 2 pixels.
...
def validate():
    ...
    train = [
        ...
        generate(
            width=18,
            height=17,
            rows=[1, 0, 2, 1, 0, 2, 1, 0],
            cols=[1, 1, 0, 0, 0, 2, 2, 2],
            brows=[2, 7],
            bcols=[2, 6],
            bmags=[1, 3],
            colors=[1, 8],
