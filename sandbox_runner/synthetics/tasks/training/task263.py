...
def validate():
    ...
    train = [
        generate(
            basicrows=[0, 0, 1, 1, 2, 2],
            basiccols=[0, 2, 1, 2, 0, 2],
            weirdrows=[0, 0, 0, 1, 1, 2, 2, 2],
            weirdcols=[0, 1, 2, 0, 2, 0, 1, 2],
            colors=[6, 4, 8],
            weird=2,
            xpose=0,
        ),
        ...
        generate(
            basicrows=[0, 1, 1, 2],
            basiccols=[0, 1, 2, 1],
            weirdrows=[0, 0, 0, 1, 2, 2, 2],
            weirdcols=[0, 1, 2, 1, 0, 1, 2],
            colors=[3, 4, 2, 8, 1],
            weird=1,
            xpose=1,
        ),
        generate(
            basicrows=[0, 1, 1, 2],
            basiccols=[0, 1, 2, 0],
            weirdrows=[0, 0, 1, 1, 2, 2],
            weirdcols=[1, 2, 0, 1, 0, 2],
            colors=[7, 3, 2, 8],
            weird=0,
            xpose=0,
        ),
