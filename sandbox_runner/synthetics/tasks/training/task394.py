...
def generate(size=None, minisize=None, colors=None, row=None, col=None, bitesize=None):
...
def validate():
    ...
    train = [
        generate(size=5, minisize=2, colors=[2, 1, 1, 1], row=3, col=0, bitesize=2),
        generate(size=4, minisize=2, colors=[8, 6, 6, 8], row=0, col=2, bitesize=1),
        generate(
            size=7,
            minisize=3,
            colors=[2, 2, 5, 2, 2, 5, 5, 5, 5],
            row=5,
            col=5,
            bitesize=2,
        ),
