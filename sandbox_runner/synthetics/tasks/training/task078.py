...
def validate():
    ...
    train = [
        ...
        generate(tops=[4, 4, 1, 4, 2, 5, 5], bottoms=[0, 0, 1, 0, 4, 0, 0], col=2),
        generate(
            tops=[4, 4, 1, 3, 4, 3, 4, 2, 4], bottoms=[0, 0, 3, 2, 0, 4, 0, 3, 0], col=1
        ),
    ]
    test = [
        generate(
            tops=[4, 1, 5, 2, 3, 2, 4, 1, 5], bottoms=[0, 3, 0, 2, 4, 1, 0, 6, 0], col=1
        ),
    ]
