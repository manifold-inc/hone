...
def validate():
    ...
    train = [
        ...
        generate(colors=[4, 7], rows=[1, 3, 4, 7, 8], cols=[2, 3, 6, 2, 7], xpose=1),
        generate(
            colors=[8, 9], rows=[1, 1, 3, 4, 6, 7], cols=[3, 6, 7, 2, 6, 3], xpose=1
        ),
    ]
    test = [
        generate(
            colors=[5, 4],
            rows=[0, 1, 1, 3, 4, 5, 7, 8, 8],
            cols=[1, 5, 8, 3, 6, 3, 4, 2, 6],
            xpose=0,
        ),
    ]
