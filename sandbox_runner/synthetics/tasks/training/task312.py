...
def generate(rows=None, cols=None, wides=None, talls=None, pattern=None, size=12):
    ...
    if rows is None:
        ...
        while True:
            ...
            if not common.overlaps(rows, cols, wides, talls):
                break
        color_list = common.random_colors(common.randint(2, 3), exclude=[common.gray()])
