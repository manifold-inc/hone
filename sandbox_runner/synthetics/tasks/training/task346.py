...
def generate(width=None, height=None, rows=None, cols=None, colors=None, center=None):
...
def validate():
    ...
    train = [
        ...
        generate(
            width=9,
            height=7,
            rows=[0, 0, 0, 1, 2, 2, 2, 2, 3, 3, 3, 3, 3, 4, 4, 4, 5, 6, 6, 6],
            cols=[0, 2, 8, 4, 2, 5, 6, 7, 0, 3, 5, 6, 7, 5, 6, 7, 2, 0, 3, 7],
            colors=[8, 8, 8, 8, 8, 3, 3, 3, 8, 3, 3, 8, 3, 3, 3, 3, 8, 3, 8, 8],
            center=8,
        ),
        generate(
            width=9,
