...
def generate(
    rows=None, cols=None, thick=None, color=None, flip=None, xpose=None, size=14
):
...
def validate():
    ...
    train = [
        generate(
            rows=[0, 2, 3, 9, 10, 11, 12],
            cols=[8, 2, 10, 9, 1, 4, 11],
            thick=4,
            color=2,
            flip=0,
            xpose=0,
        ...
        generate(
            rows=[1, 1, 1, 2, 3, 3, 4, 10, 11, 12, 13],
