...
def generate(
    width=None, height=None, rows=None, cols=None, brow=None, bcol=None, showall=None
):
    ...
    for dr, dc in [(-1, -1), (-1, 1), (1, -1), (1, 1)]:
        ...
        for r, c in zip(rows, cols):
            ...
            if not showall and (dr > 0 or dc > 0):
                continue
...
def validate():
    ...
    train = [
        generate(
            width=30,
            height=20,
            rows=[0, 0, 0, 0, 1, 1, 2, 2, 3, 3],
            cols=[0, 1, 2, 3, 0, 3, 0, 3, 0, 3],
            brow=7,
            bcol=9,
            showall=0,
        ),
    ...
    test = [
        generate(
            width=14,
            height=18,
            rows=[0, 0, 1, 2, 3, 3, 3, 3],
            cols=[0, 1, 1, 2, 0, 1, 2, 3],
            brow=6,
            bcol=6,
            showall=0,
        ),
