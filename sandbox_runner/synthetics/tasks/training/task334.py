...
def validate():
    ...
    train = [
        generate(
            rows=[0, 1, 1, 2, 2, 3, 3, 4, 4], cols=[0, 1, 4, 0, 3, 3, 4, 2, 3], color=2
        ),
        generate(
            rows=[1, 1, 1, 2, 2, 2, 3, 3, 4], cols=[2, 3, 4, 1, 3, 4, 1, 3, 4], color=1
        ),
        generate(
            rows=[0, 1, 1, 2, 2, 3, 3, 4, 4, 4],
            cols=[0, 3, 4, 1, 2, 1, 3, 0, 2, 3],
            color=3,
        ),
        generate(
            rows=[0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4],
            cols=[0, 2, 0, 3, 4, 0, 1, 3, 1, 3, 0, 4],
            color=1,
        ),
        generate(
            rows=[0, 0, 0, 1, 1, 2, 2, 3, 3, 3, 4, 4, 4, 4],
            cols=[0, 2, 4, 0, 4, 0, 1, 0, 3, 4, 0, 1, 2, 4],
            color=2,
        ),
        generate(
            rows=[0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4],
            cols=[1, 3, 1, 2, 3, 1, 2, 4, 0, 1, 2, 2, 4],
            color=2,
        ),
        generate(
            rows=[0, 0, 1, 1, 2, 3, 4, 4, 4], cols=[1, 3, 0, 1, 1, 2, 0, 1, 2], color=3
        ),
    ]
    test = [
        generate(
            rows=[0, 0, 0, 0, 1, 1, 2, 3, 3, 4],
            cols=[0, 1, 2, 3, 2, 4, 1, 1, 4, 2],
            color=1,
        ),
        generate(rows=[0, 0, 0, 1, 2, 3, 3, 4], cols=[1, 3, 4, 2, 0, 2, 4, 4], color=3),
    ]
