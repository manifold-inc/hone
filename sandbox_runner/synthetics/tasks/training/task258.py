...
def validate():
    ...
    train = [
        ...
        generate(size=10, rows=[1, 4, 6, 8], cols=[1, 2, 6, 3], lengths=[7, 3, 3, 3]),
        generate(
            size=10, rows=[1, 2, 5, 7, 9], cols=[6, 1, 3, 4, 1], lengths=[3, 3, 5, 3, 3]
        ),
    ]
    test = [
        generate(
            size=10, rows=[0, 2, 4, 5, 7], cols=[1, 2, 1, 5, 3], lengths=[3, 7, 3, 3, 3]
        ),
    ]
