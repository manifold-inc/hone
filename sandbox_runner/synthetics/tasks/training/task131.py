...
def validate():
    ...
    train = [
        generate(
            width=16,
            height=4,
            rows=[0, 1, 1, 1, 2, 2, 3, 3, 3],
            cols=[1, 1, 2, 3, 0, 1, 1, 2, 3],
            offset=0,
            redline=10,
            flip=0,
            xpose=0,
        ...
        generate(
            width=17,
            height=5,
            rows=[4, 3, 3, 2, 1, 1, 1, 0, 0, 0],
            cols=[2, 2, 3, 3, 0, 2, 3, 0, 1, 2],
            offset=1,
            redline=15,
            flip=0,
            xpose=1,
        ...
        generate(
            width=17,
            height=5,
            rows=[0, 0, 0, 1, 1, 2, 3, 3, 3],
            cols=[0, 1, 2, 0, 2, 2, 0, 1, 2],
            offset=3,
            redline=13,
            flip=1,
            xpose=1,
