...
def validate():
    ...
    train = [
        ...
        generate(width=4, height=4, rows=[0, 0, 0, 1, 2, 3], cols=[0, 1, 2, 1, 3, 1]),
        generate(
            width=4,
            height=5,
            rows=[0, 0, 1, 2, 2, 2, 4, 4, 4],
            cols=[0, 1, 1, 0, 1, 3, 1, 2, 3],
        ),
        generate(width=3, height=3, rows=[0, 0, 1, 1, 2], cols=[0, 1, 0, 2, 1]),
    ]
    test = [
        generate(
            width=4,
            height=5,
            rows=[0, 0, 0, 1, 2, 3, 4, 4],
