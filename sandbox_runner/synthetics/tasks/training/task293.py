...
def generate(width=None, height=None, offsets=None, thicks=None, colors=None, flip=0):
    ...
    if width is None:
        ...
        offsets = [
            common.randint(1, width - thicks[0] - 1),
...
def validate():
    ...
    train = [
        generate(
            width=13, height=13, offsets=[3, 3], thicks=[2, 3], colors=[8, 3], flip=0
        ),
        generate(
            width=9, height=7, offsets=[2, 3], thicks=[2, 1], colors=[6, 1], flip=1
        ),
        generate(
            width=7, height=8, offsets=[2, 3], thicks=[1, 1], colors=[1, 7], flip=1
        ),
        generate(
            width=6, height=8, offsets=[1, 4], thicks=[1, 1], colors=[3, 2], flip=0
        ),
    ]
    test = [
        generate(
            width=6, height=11, offsets=[2, 2], thicks=[2, 2], colors=[4, 5], flip=0
        ),
    ]
