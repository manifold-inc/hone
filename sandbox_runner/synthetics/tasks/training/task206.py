...
def generate(
    ...
    if width is None:
        ...
        while True:
            ...
            if (1, 1) not in zip(rows, cols):
                continue  # Center must be taken.
            if common.connected(list(zip(rows, cols))):
                break
        ...
        while True:
            ...
            if abs(tworows[1] - tworows[0]) >= 4:
                break
            if abs(twocols[1] - twocols[0]) >= 4:
                break
