...
def generate(
    rows=None, cols=None, wides=None, talls=None, colors=None, xpose=None, size=10
):
...
def validate():
    ...
    train = [
        generate(
            rows=[0, 5], cols=[1, 3], wides=[4, 5], talls=[4, 4], colors=[7, 8], xpose=0
        ),
        generate(
            rows=[0, 5], cols=[0, 2], wides=[5, 6], talls=[4, 4], colors=[6, 7], xpose=0
        ),
        generate(
            rows=[0, 7], cols=[1, 7], wides=[6, 3], talls=[7, 3], colors=[4, 2], xpose=0
        ),
    ]
    test = [
        generate(
