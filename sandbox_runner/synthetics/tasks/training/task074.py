...
def generate(
    colors=None, rows=None, cols=None, wides=None, talls=None, size=30, trisize=16
):
        ...
        for r in range(trisize):
            for c in range(r + 1):
                ...
                for row, col in cells:
                    ...
                    if common.get_pixel(grid, row, col) == common.maroon():
                        continue
    ...
    if colors is None:
        ...
        for _ in range(4 * size):
            ...
            if common.randint(0, 1):
                common.draw(grid, row + 1, col, color)
            if common.randint(0, 1):
                common.draw(grid, row, col + 1, color)
            if common.randint(0, 1):
                common.draw(grid, row + 1, col + 1, color)
        colors = []
        for r in range(trisize):
            for c in range(r + 1):
