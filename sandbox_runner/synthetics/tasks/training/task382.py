...
def generate(width=None, height=None, rows=None, cols=None, flip=None, gravity=None):
...
def validate():
    ...
    train = [
        generate(
            width=12, height=17, rows=[4, 10], cols=[1, 5, 7, 9], flip=0, gravity=0
        ),
        generate(width=10, height=14, rows=[3, 7, 11], cols=[3, 7], flip=1, gravity=0),
        generate(width=12, height=12, rows=[4, 8], cols=[2, 5, 9], flip=1, gravity=1),
    ]
    test = [
        generate(
            width=12, height=17, rows=[5, 10, 14], cols=[1, 3, 6, 9], flip=1, gravity=3
        ),
    ]
