...
def generate(
    width=None, height=None, row=None, col=None, wide=None, tall=None, colors=None
):
...
def validate():
    ...
    train = [
        generate(width=14, height=14, row=2, col=1, wide=5, tall=6, colors=[2, 3]),
        generate(width=14, height=17, row=3, col=2, wide=8, tall=11, colors=[1, 8]),
        generate(width=16, height=17, row=3, col=2, wide=11, tall=10, colors=[2, 4]),
        generate(width=16, height=17, row=3, col=4, wide=8, tall=5, colors=[3, 8]),
    ]
    test = [
        generate(width=18, height=17, row=4, col=2, wide=10, tall=11, colors=[4, 1]),
    ]
