...
def generate(rows=None, cols=None, colors=None, brow=None, bcol=None, size=10):
    ...
    if rows is None:
        ...
        rows, cols, colors = [], [], common.random_colors(4, exclude=[common.cyan()])
...
def validate():
    ...
    train = [
        generate(
            rows=[3, 0, 8, 9], cols=[1, 8, 1, 9], colors=[6, 7, 4, 9], brow=4, bcol=4
        ),
        generate(
            rows=[0, 1, 8, 6], cols=[2, 8, 1, 9], colors=[5, 9, 2, 1], brow=4, bcol=4
        ),
        generate(
            rows=[0, 0, 7, 6], cols=[3, 9, 2, 9], colors=[1, 4, 3, 6], brow=2, bcol=5
        ),
    ]
    test = [
        generate(
            rows=[3, 1, 9, 8], cols=[1, 6, 2, 8], colors=[3, 4, 6, 7], brow=4, bcol=4
        ),
    ]
