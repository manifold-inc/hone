...
def generate(
    rows=None, cols=None, idxs=None, brows=None, bcols=None, colors=None, size=10
):
    ...
    if rows is None:
        ...
        while True:
            ...
            if not common.overlaps_1d(bcols, wides):
                break
...
def validate():
    ...
    train = [
        generate(
            rows=[0, 0, 1, 1, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 0, 0, 0, 1, 2],
        ...
        generate(
            rows=[0, 0, 0, 1, 0, 1, 1, 0, 0, 1, 1, 2, 0, 1, 2, 3],
        ...
        generate(
            rows=[0, 1, 2, 0, 0, 1, 0, 0, 0],
            cols=[0, 0, 0, 0, 1, 0, 0, 1, 2],
            idxs=[0, 0, 0, 1, 1, 1, 2, 2, 2],
            brows=[2, 5, 3],
            bcols=[1, 3, 7],
            colors=[1, 4, 8],
        ),
    ...
    test = [
        generate(
            rows=[0, 1, 2, 0, 1, 1, 2, 0, 0, 1, 2, 0, 0, 0, 1, 1, 1],
