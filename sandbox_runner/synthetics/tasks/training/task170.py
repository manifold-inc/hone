...
def generate(
    ...
    if width is None:
        while True:
            ...
            if not common.diagonally_connected(list(zip(rows, cols))):
                continue
...
def validate():
    ...
    test = [
        generate(
            width=24,
            height=21,
            rows=[0, 0, 0, 1, 1, 2, 2, 2, 2, 3, 3],
            cols=[0, 2, 3, 1, 2, 0, 1, 2, 3, 0, 3],
            srow=1,
            scol=2,
            smag=3,
            brow=15,
